        ...
        public override void RenderLeftToggleField(Graphics g, Rectangle leftRectangle, int totalToggleFieldWidth)
        {
            ...
            if (ToggleSwitch.OnSideImage != null || !string.IsNullOrEmpty(ToggleSwitch.OnText))
            {
                ...
                else if (!string.IsNullOrEmpty(ToggleSwitch.OnText))
                {
                    ...
                    Color leftSideBackColor1 = Color.Blue;
                    Color leftSideBackColor2 = Color.Blue;

                    using (Brush backgroundBrush = new LinearGradientBrush(fullRectangle, leftSideBackColor1, leftSideBackColor2, LinearGradientMode.Vertical))
                    {
                        g.FillRectangle(backgroundBrush, fullRectangle);
                    }
