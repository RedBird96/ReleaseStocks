...
{
    public class BlendedConfigurableBenchmark : BenchmarkBase
    {
        public static String CODE = "^BLENDED_CONFIGURABLE";
        ...
        String logFileName = "logBlendedConfigurable";

        public BlendedConfigurableBenchmark(PortfolioParameters portfolio, List<CachedValuesStock> cachedStocks)
        {
            benchmarkPercent = portfolio.BABStocksPercent;
            asset1Percent = portfolio.BABBondsPercent + portfolio.BABCashPercent;

            benchmarkSymbol = cachedStocks.Find(x => x.IdStock == portfolio.BABRiskAssetConfigurable1);
            asset1 = cachedStocks.Find(x => x.IdStock == portfolio.BABRiskAssetConfigurable2);
            ...
            DebugDataLogger.Instance.WriteLine(logFileName, "Date\tPriceSPY\tPriceAGG\tQttySPY\tQttyAGG\tAction\tLeftoverCash\tTotalValue");
        }
